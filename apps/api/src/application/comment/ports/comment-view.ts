 ...
 *
 * `author` réutilise `AuthorView`, qui vit dans `application/shared/` et non
 * dans le contexte article. Ce n'est pas de l'économie de lignes : les deux
 ...
 * justement supprimée au domaine.
 */
